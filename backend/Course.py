...
class Course(object):
    ...
    def add_student(self: Course,student: Student) -> None:
        self._students.add(student)
    
    def remove_student(self: Course,student: Student) -> None:
        self._students.difference_update(set(student))
        
    def add_admin(self: Course,admin: Admin):
        self._admins.add(student)

    def remove_admin(self: Course,admin: Admin):
        self._admins.difference_update(set(admin))

    def add_TutorEvent(self: Course, event):
